...
class OverviewCity(QDialog):
    ...
    def __init__(self, weatherdata, icon, forecast, dayforecast, unit,
        ...
        self.wind_label = QLabel('<font size="3" color=grey><b>' +
                                 self.tr('Wind') + '<\font><\b>')
        self.wind_label.setAlignment(Qt.AlignTop | Qt.AlignRight)
        ...
        self.clouds_label.setAlignment(Qt.AlignRight)
        ...
        self.pressure_label.setAlignment(Qt.AlignRight)
        ...
        self.precipitation_label = QLabel('<font size="3" color=grey><b>' +
                                          ...
                                          '<\b><\font>')
        self.precipitation_label.setAlignment(Qt.AlignRight)
        ...
        self.sunrise_label.setAlignment(Qt.AlignRight)
        ...
        self.uv_label = QLabel(
            '<font size="3" color=grey><b>' + QCoreApplication.translate(
                ...
                '<\b><\font>'))
        self.uv_label.setAlignment(Qt.AlignTop | Qt.AlignRight)
